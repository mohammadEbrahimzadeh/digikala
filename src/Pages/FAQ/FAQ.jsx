...
export default function FAQ() {
  return (
    <div className="FAQ">
      ...
      <div className="col-12 bodyFaq  mt-3 d-flex flex-column align-items-center justify-content-center gap-3 ">
        <div className="rounded rounded-1 p-3  border-1 border-info border rounded-circle bg-white">
          <FaQuestion className="text-info iconBody" />
        </div>
        <div>
          <h1 className="text-center text-black titleBody">پرسش‌ های متداول</h1>
        </div>
        <div className="col-12 mt-2 pb-3 accordionContainer">
